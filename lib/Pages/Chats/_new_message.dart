...
import 'package:social_app1/Pages/Chats/_receve_message_card.dart';
import 'package:social_app1/Pages/Chats/_send_message_card.dart';
...
class NewMessagePage extends StatefulWidget {
  ...
  const NewMessagePage({Key? key, this.conversationModel, this.user})
      : super(key: key);
  @override
...
class _NewMessagePageState extends State<NewMessagePage> {
  ...
  addmessage() async {
    Map<String, String> data = {
      ...
      "receverId": "${widget.conversationModel?.receiver.id}"
    };
